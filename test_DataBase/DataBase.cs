...
namespace test_DataBase
{
    ...
    {
        private readonly SqlConnection sqlConnection = new SqlConnection(@"Data Source=MS-SQL\SQLExpress;Initial Catalog=ComputerRepairManagement;Integrated Security=True");
